...
<body>
	...
	<section class="popular-places-area section_gap_bottom">
		...
		<div class="popular-places-slider owl-carousel">
			<a href="img/places/p1.jpg"
				class="single-popular-places d-block img-gal">
		...
		<div class="container">
					...
					<div class="testi-item">
						...
						<div class="wow fadeIn" data-wow-duration="1s">
							<p>
								...
								our dear <br> Mother Earth. If you think about it, you
								travel across her faceand She is the host <br> to your
								journey.
							</p>
						</div>
					</div>
					...
					<div class="testi-item">
						...
						<div class="wow fadeIn" data-wow-duration="1s">
							<p>
								...
								her face <br> and She is the host to your journey.
							</p>
						</div>
					</div>
				</div>
			...
			<div class="owl-thumbs d-flex justify-content-center"
				...
				<div class="owl-thumb-item">
					<div>
						<img class="img-fluid rounded-circle" src="img/testimonial/t1.jpg"
							alt="">
					</div>
				...
				<div class="owl-thumb-item">
					<div>
						<img class="img-fluid rounded-circle" src="img/testimonial/t2.jpg"
							alt="">
					</div>
					<div class="overlay overlay-grad"></div>
				</div>
				<div class="owl-thumb-item">
					<div>
						<img class="img-fluid rounded-circle" src="img/testimonial/t3.jpg"
							alt="">
					</div>
					<div class="overlay overlay-grad"></div>
				</div>
				<div class="owl-thumb-item">
					<div>
						<img class="img-fluid rounded-circle" src="img/testimonial/t4.jpg"
							alt="">
					</div>
					<div class="overlay overlay-grad"></div>
				</div>
					...
					<div class="single-blog">
						...
						<div class="blog-details">
							<div class="blog-meta d-flex">
								<p>
									<a href="#"> <span class="fa fa-calendar"></span> 13th Dec
									</a>
								</p>
								<p>
									<a href="#"> <span class="fa fa-heart-o"></span> 15
									</a>
								</p>
								<p>
									<a href=""></a>
